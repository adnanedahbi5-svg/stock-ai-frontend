                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                  <div class="d-flex">
                        ...
                        <g transform="translate(-0.785)">
                          ...
                          <g transform="translate(0.348)">
                            ...
                            <ellipse
                              ...
                              rx="14.853"
                              ry="15.096"
                              transform="translate(49.907 20.585)"
                              fill="#ffe70c"
                    ...
                    <div>
                      ...
                      <p class="mb-0 fs-13"><i class="fas fa-map-marker-alt me-2 text-primary"></i>Manchester, England</p>
                    </div>
                  </div>
                  <div class="job-available mt-sm-0 mt-3">
                    <a href="javascript:void(0);" class="btn btn-outline-primary btn-sm btn-rounded">6 Jobs Available</a>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap">
                  <div class="d-flex">
                    <div class="icon-img-bx lg me-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width="97" height="97" viewBox="0 0 97 97">
                        <g transform="translate(-0.785)">
                          <rect width="97" height="97" rx="12" transform="translate(0.785)" fill="#c5c5c5" />
                          <g transform="translate(0.348)">
                            <rect data-name="placeholder" width="97" height="97" rx="12" transform="translate(0.438)" fill="#676767" />
                            <ellipse data-name="Ellipse 12" cx="24.359" cy="24.702" rx="24.359" ry="24.702" transform="translate(20.2 27.447)" fill="#fff" />
                            <ellipse
                              data-name="Ellipse 11"
                              cx="14.853"
                    ...
                    <div>
                      <h4 class="mb-0">Kelon inc.</h4>
                      <p class="mb-2">Desgin Team Agency</p>
                      <p class="mb-0 fs-13"><i class="fas fa-map-marker-alt text-primary me-2"></i>Manchester, England</p>
                    </div>
                  </div>
                  <div class="job-available mt-sm-0 mt-3">
                    <a href="javascript:void(0);" class="btn btn-outline-primary btn-sm btn-rounded">6 Jobs Available</a>
                    ...
                    <div class="icon-img-bx lg me-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width="97" height="97" viewBox="0 0 97 97">
                        <g transform="translate(-0.785)">
                          <rect width="97" height="97" rx="12" transform="translate(0.785)" fill="#c5c5c5" />
                          <g transform="translate(0.348)">
                            <rect data-name="placeholder" width="97" height="97" rx="12" transform="translate(0.438)" fill="#f94a4a" />
                            <ellipse data-name="Ellipse 12" cx="24.359" cy="24.702" rx="24.359" ry="24.702" transform="translate(20.2 27.447)" fill="#fff" />
                            <ellipse
                              data-name="Ellipse 11"
                              cx="14.853"
                    ...
                    <div class="icon-img-bx lg me-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width="97" height="97" viewBox="0 0 97 97">
                        <g transform="translate(-0.785)">
                          <rect width="97" height="97" rx="12" transform="translate(0.785)" fill="#c5c5c5" />
                          <g transform="translate(0.348)">
                            <rect data-name="placeholder" width="97" height="97" rx="12" transform="translate(0.438)" fill="#ee9827" />
                            <ellipse data-name="Ellipse 12" cx="24.359" cy="24.702" rx="24.359" ry="24.702" transform="translate(20.2 27.447)" fill="#fff" />
                            <ellipse
                              data-name="Ellipse 11"
                              cx="14.853"
