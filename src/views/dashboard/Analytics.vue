            ...
            <div class="any-card">
              <div class="c-con">
                <h4 class="heading mb-0">
                  Congratulations <strong>Hanu!!</strong
                  ><img src="../../assets/images/crm/party-popper.png" alt="" />
                </h4>
                ...
                <RouterLink to="/app-profile-1" class="btn btn-primary btn-sm"
                  >View Profile</RouterLink
                >
              </div>
              <img
                src="../../assets/images/analytics/developer_male.png"
                class="harry-img"
                alt=""
              />
            </div>
        ...
        <div class="card bg-primary">
          ...
          <div class="card-body">
            <div class="d-flex justify-content-between">
              <div class="sales-bx">
                <img src="../../assets/images/analytics/sales.png" alt="" />
                <h4>$3,651</h4>
                <span>Total Sales</span>
              </div>
              <div class="sales-bx">
                <img src="../../assets/images/analytics/shopping.png" alt="" />
                <h4>5831</h4>
                <span>Total Sales</span>
              </div>
            </div>
        ...
        <div class="card">
          ...
          <div class="card-body p-0 custome-tooltip">
            <div id="SalesChart">
              <apexchart
                height="125px"
                :options="NewCustomers.chartOptions"
          ...
          <div class="card-body mt-xl-4 mt-0 pb-1">
            <div class="row align-items-center">
              <div class="col-xl-2">
                ...
                <p class="mb-0 text-primary pb-4">
                  Yout statistics for<br />
                  1 month period.
                </p>
              </div>
              <div class="col-xl-10">
          ...
          <div class="card-body py-0">
            <div class="row align-items-center">
              ...
              <div class="col-xl-9 custome-tooltip">
                <div id="chartBar" class="chartBar1">
                  <apexchart
                    height="250px"
                    :options="analyticsChartbar.chartOptions"
                    :series="analyticsChartbar.series"
                  ></apexchart>
                </div>
              </div>
            </div>
            ...
            <ul class="country-sale dz-scroll">
              <li class="d-flex">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                  ...
                  <span class="badge badge-primary border-0 ms-2"
                    >25.8%<i class="fa-solid fa-chevron-up ms-2 text-white"></i
                  ></span>
                </div>
              </li>
              <li class="d-flex">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                  ...
                  <span class="badge badge-secondary border-0 ms-2"
                    >18.5%<i class="fa-solid fa-chevron-down ms-2 text-white"></i
                  ></span>
                </div>
              </li>
              <li class="d-flex">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                  ...
                  <span class="badge badge-info border-0 ms-2"
                    >59.5%<i class="fa-solid fa-chevron-up ms-2 text-white"></i
                  ></span>
                </div>
              </li>
              <li class="d-flex">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                  ...
                  <span class="badge badge-success border-0 ms-2"
                    >60.5%<i class="fa-solid fa-chevron-up ms-2 text-white"></i
                  ></span>
                </div>
              </li>
              <li class="d-flex">
              ...
              <li class="d-flex">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                  ...
                  <span class="badge badge-light border-0 ms-2"
                    >60.5%<i class="fa-solid fa-chevron-down ms-2 text-white"></i
                  ></span>
                </div>
              </li>
              <li class="d-flex">
              ...
              <div class="card-body d-flex justify-content-between align-items-center">
                <div class="d-flex">
                  <div class="icon-box icon-box-md bg-danger-light me-1">
                    <i class="fa-brands fa-salesforce text-danger"></i>
                  </div>
                  <div class="ms-2">
                    <h4>$5,536</h4>
        ...
        <div class="card">
          ...
          <div class="card-body pb-0">
            <div id="TotalEarning">
              <apexchart
                height="125px"
                :options="TotalEarning.chartOptions"
...
export default defineComponent({
  name: 'Analytics_',
  components: { apexchart: VueApexCharts, RouterLink },
  data() {
    return {
      NewCustomers,
      EarningChart,
