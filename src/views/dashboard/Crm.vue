      ...
      <div class="col-xl-2 col-xxl-3 col-sm-4">
        <div class="card crm-cart">
          ...
          <div class="card-body d-flex justify-content-center pt-2">
            <div id="AllProject" class="ms-0">
              <apexchart
                height="125px"
                :options="AllProject.chartOptions"
                :series="AllProject.series"
              ></apexchart>
            </div>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-xl-9 col-xxl-8 col-md-8">
                <div id="ProjectChart">
                  <apexchart
                    height="207px"
                    :options="ProjectChart.chartOptions"
        ...
        <div class="card">
          ...
          <div class="card-body py-0 custome-tooltip">
            <div id="activity1">
              <apexchart
                height="230px"
                :options="activity1.chartOptions"
                :series="activity1.series"
              ></apexchart>
            </div>
            <div>
              <h4 class="mb-0">80%</h4>
        ...
        <div class="card">
          ...
          <div class="card-body py-0 pb-3">
            ...
            <ul class="sociallinks">
              <li class="d-flex">
                <div class="icon">
                  <img src="../../assets/images/crm/dribble.png" class="icon-box" alt="" />
                </div>
              ...
              <li class="d-flex">
                <div class="icon">
                  <img src="../../assets/images/crm/facebook.png" class="icon-box" alt="" />
                </div>
                <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                  <div class="ms-2">
              ...
              <li class="d-flex">
                <div class="icon">
                  <img src="../../assets/images/crm/instagram.png" class="icon-box" alt="" />
                </div>
                <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                  <div class="ms-2">
              ...
              <li class="d-flex">
                <div class="icon">
                  <img src="../../assets/images/crm/linkedin.png" class="icon-box" alt="" />
                </div>
                <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                  <div class="ms-2">
              ...
              <li class="d-flex">
                <div class="icon">
                  <img src="../../assets/images/crm/pinterest.png" class="icon-box" alt="" />
                </div>
                <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                  <div class="ms-2">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                  <div class="ms-2">
                    ...
                    <small
                      ...
                      ><span>21 Jul | 08:20-10:30</span></small
                    >
                  </div>
              ...
              <li class="d-flex">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                  <div class="ms-2">
                    ...
                    <small
                      ><i class="fa-solid fa-calendar-days me-2"></i
                      ><span>23 May | 07:08-09:30</span></small
                    >
                  </div>
              ...
              <li class="d-flex">
                ...
                <div class="d-flex flex-wrap align-items-center justify-content-between w-100">
                  <div class="ms-2">
                    ...
                    <small
                      ><i class="fa-solid fa-calendar-days me-2"></i
                      ><span>10 April | 08:08-09:30</span></small
                    >
                  </div>
                  <span class="badge badge-info border-0 ms-2">Manager</span>
                </div>
        ...
        <div class="card">
          ...
          <div class="card-body custome-tooltip pb-0">
            ...
            <div id="ExtraData">
              <apexchart
                height="250px"
                :options="ExtraData.chartOptions"
