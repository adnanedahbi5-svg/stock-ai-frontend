        ...
        <div class="card">
          ...
          <div class="card-body py-0 custome-tooltip">
                ...
                <div class="card">
                  ...
                  <div class="card-body p-0 custome-tooltip">
                    <div id="sessionsChart">
                      <apexchart
                        height="50px"
                        :options="sessionsChart.chartOptions"
                ...
                <div class="card">
                  ...
                  <div class="card-body p-0 custome-tooltip">
                    <div id="LiveChart">
                      <apexchart
                        height="50px"
                        :options="LiveChart.chartOptions"
            ...
            <div id="chartBarRunning">
              <apexchart
                height="300px"
                :options="chartBarRunning.chartOptions"
                :series="chartBarRunning.series"
              ></apexchart>
            </div>
          </div>
        </div>
                    ...
                    <tbody>
                      <tr class="heading-data">
                        ...
                        <td>
                          ...
                          >
                            <path
                              d="M2.245,29H4a1,1,0,0,1,1,1A24.943,24.943,0,0,0,17.2,51.465a6.144,6.144,0,0,1,1.976-3.195l.188-.163A20.9,20.9,0,0,1,9,30a1,1,0,0,1,1-1h1.755a.229.229,0,0,0,.222-.141.218.218,0,0,0-.037-.25L7.186,23.084a.247.247,0,0,0-.371,0L2.06,28.609a.218.218,0,0,0-.037.25A.229.229,0,0,0,2.245,29Z"
                            />
                            <path
                              d="M11.738,19.167l.163.19A20.869,20.869,0,0,1,30,9a1,1,0,0,1,1,1v1.755a.229.229,0,0,0,.141.222.219.219,0,0,0,.25-.037l5.524-4.754a.247.247,0,0,0,0-.372L31.391,2.06a.221.221,0,0,0-.25-.037A.229.229,0,0,0,31,2.245V4a1,1,0,0,1-1,1A24.94,24.94,0,0,0,8.535,17.2a6.2,6.2,0,0,1,3.2,1.971Z"
                            />
                            <path
                              d="M28.859,48.023a.252.252,0,0,0-.1-.023.223.223,0,0,0-.147.06l-5.526,4.754a.248.248,0,0,0,0,.372l5.525,4.754a.221.221,0,0,0,.25.037A.229.229,0,0,0,29,57.755V56a1,1,0,0,1,1-1A24.943,24.943,0,0,0,51.466,42.8a6.246,6.246,0,0,1-3.2-1.98v0l-.155-.179A20.9,20.9,0,0,1,30,51a1,1,0,0,1-1-1V48.245A.229.229,0,0,0,28.859,48.023Z"
                            />
                            <path
                              d="M51,30a1,1,0,0,1-1,1H48.245a.229.229,0,0,0-.222.141.218.218,0,0,0,.037.25l4.754,5.524a.216.216,0,0,0,.371,0l4.755-5.525a.218.218,0,0,0,.037-.25A.229.229,0,0,0,57.755,31H56a1,1,0,0,1-1-1A24.941,24.941,0,0,0,42.8,8.534a6.239,6.239,0,0,1-1.98,3.2l-.181.156A20.9,20.9,0,0,1,51,30Z"
                            />
                          </svg>
                        </td>
                      </tr>
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img
                              src="../../assets/images/crm/dribble.png"
                        ...
                        <td class="text-success">
                          <i class="fa-solid fa-arrow-trend-up me-1"></i> 2.556
                        </td>
                        <td>$4,3655</td>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img
                              src="../../assets/images/crm/facebook.png"
                              class="avatar avatar-lg"
                              alt=""
                            />
                            <div class="ms-2 dr-data">
                        ...
                        <td class="text-danger">
                          <i class="fa-solid fa-arrow-trend-down me-1"></i> 2.556
                        </td>
                        <td>$3,2342</td>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img
                              src="../../assets/images/crm/instagram.png"
                              class="avatar avatar-lg"
                              alt=""
                            />
                            <div class="ms-2 dr-data">
                        ...
                        <td>Meta</td>
                        <td class="text-success">
                          <i class="fa-solid fa-arrow-trend-down me-1"></i> 4.556
                        </td>
                        <td>$4,3655</td>
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img
                              src="../../assets/images/crm/linkedin.png"
                              class="avatar avatar-lg"
                              alt=""
                            />
                            <div class="ms-2 dr-data">
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img
                              src="../../assets/images/crm/bing.png"
                              class="avatar avatar-lg"
                              alt=""
                            />
                            <div class="ms-2 dr-data">
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img
                              src="../../assets/images/crm/twitter.png"
                              class="avatar avatar-lg"
                              alt=""
                            />
                            <div class="ms-2 dr-data">
                      ...
                      <tr>
                        <td>
                          <div class="d-flex align-items-center">
                            <img
                              src="../../assets/images/crm/whatsapp.png"
                              class="avatar avatar-lg"
                              alt=""
                            />
                            <div class="ms-2 dr-data">
            ...
            <div class="card sale-card">
              <div class="card-header pb-0 border-0 align-items-baseline">
                ...
                <span class="badge badge-primary border-0"
                  >3.5<i class="fa-solid fa-caret-up ms-1"></i
                ></span>
              </div>
              <div class="card-body p-0 custome-tooltip">
                <div id="totalSale">
                  <apexchart
                    height="50px"
                    :options="totalSale.chartOptions"
            ...
            <div class="card sale-card">
              <div class="card-header pb-0 border-0 align-items-baseline">
                ...
                <span class="badge badge-secondary border-0"
                  >5.5<i class="fa-solid fa-caret-down ms-1"></i
                ></span>
              </div>
              <div class="card-body p-0 custome-tooltip">
                <div id="totalPurchase">
                  <apexchart
                    height="50px"
                    :options="totalPurchase.chartOptions"
                    :series="totalPurchase.series"
                  ></apexchart>
                </div>
              </div>
              <div class="card-footer border-0">
          ...
          <div class="col-xl-4 col-md-4">
            <div class="card sale-card">
              <div class="card-header pb-0 border-0 align-items-baseline">
                ...
                <span class="badge badge-info border-0"
                  >6.5<i class="fa-solid fa-caret-down ms-1"></i
                ></span>
              </div>
              <div class="card-body p-0 custome-tooltip">
                <div id="activeCustomers">
                  <apexchart
                    height="50px"
                    :options="activeCustomers.chartOptions"
          ...
          <div class="col-xl-12">
            <div class="card">
              <div class="card-header border-0 chart-card">
                <div class="d-flex align-items-center">
                  <img src="../../assets/images/crm/pie-chart.png" alt="" />
                  <div class="ms-2">
                    <h4 class="mb-0">
                      1,555k
                      <small class="fs-12 text-success"
                        ><i class="fa-solid fa-arrow-trend-down mx-2"></i>(3.56)</small
                      >
                    </h4>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-2">
                    <h4 class="mb-0">
                      1,5832k
                      <small class="fs-12 text-success"
                        ><i class="fa-solid fa-arrow-trend-up mx-2"></i>(5.66)</small
                      >
                    </h4>
                    <span>Lorem Ipsum</span>
                  </div>
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-2">
                    <h4 class="mb-0">
                      5:22:23<small class="fs-12 text-success"
                        ><i class="fa-solid fa-arrow-trend-down mx-2"></i>(3.56)</small
                      >
                    </h4>
          ...
          <div class="col-xl-6 col-sm-6">
            <div class="card">
              <div class="card-body">
                ...
                <apexchart :options="chartOptions2" :series="series"></apexchart>
              </div>
            </div>
          </div>
          <div class="col-xl-12">
            <div class="card">
              ...
              <div class="card-body p-0">
                <div id="salesFigures">
                  <apexchart
                    :options="salesFigures.chartOptions"
                    :series="salesFigures.series"
                  ></apexchart>
                </div>
                <div>
                  <div class="table-responsive active-projects task-table">
  ...
  setup() {
    return {
      series: [
        {
          name: 'bar chart',
          data: [90, 110, 80, 85, 92, 60, 81, 95, 71, 96, 81, 95, 71, 96],
          bars: {
            show: true,
            lineWidth: 0,
            fillColor: '#FFAA2B'
