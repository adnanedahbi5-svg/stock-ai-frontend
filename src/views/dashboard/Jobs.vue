  ...
  <div class="container-fluid">
    <div class="d-flex align-items-center flex-wrap search-job mb-4">
      <div class="col-xl-2 col-xxl-3 col-lg-3 col-sm-6 col-12 search-dropdown d-flex align-items-center">
        <div class="dropdown bootstrap-select form-control border-0 default-select dashboard-select-1 wide h-auto">
          <JobSelectOption :options="[{ title: 'Choose Location' }, { title: 'London' }, { title: 'Perice' }]" />
        </div>
      </div>
      <div class="col-xl-2 col-xxl-3 col-lg-3 col-sm-6 col-12 search-dropdown d-flex align-items-center">
        <div class="dropdown bootstrap-select form-control border-0 default-select dashboard-select-1 wide h-auto">
          <JobSelectOption :options="[{ title: 'Salary Range' }, { title: 'London' }, { title: 'Perice' }]" />
        </div>
      </div>
      <div class="col-xl-8 col-xxl-6 col-lg-6 col-12 d-md-flex job-title-search pe-0">
        <div class="input-group search-box">
          ...
          <a href="javascript:void(0)" class="btn btn-primary btn-rounded">Search<i class="flaticon-381-search-2 ms-2 d-inline-block"></i></a>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-xl-9">
        <div class="mt-3 d-flex justify-content-between align-items-center flex-wrap">
          ...
          <div class="d-flex align-items-center mb-4">
            ...
            <div>
              <div class="dropdown bootstrap-select default-select dashboard-select border-0">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane fade" id="List1">
            <div class="row">
              <div class="col-xl-12">
                <div class="d-flex flex-wrap search-row p-3 mb-3 rounded justify-content-between align-items-center">
                  <div class="d-flex col-lg-3 col-sm-6 align-items-center mb-lg-0 mb-3">
                    ...
                    <div>
                      <h2 class="title"><a href="javascript:void(0);" class="text-dark">Programmer</a></h2>
                      <span class="text-primary fs-13">Highspeed Studios</span>
                    </div>
                  </div>
                  <div class="d-flex col-lg-3 col-sm-6 align-items-center mb-lg-0 mb-3">
                    <svg class="me-3 svg-ico" width="48" height="48" viewBox="0 0 54 54" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="d-flex flex-wrap search-row p-3 mb-3 rounded justify-content-between align-items-center">
                  <div class="d-flex col-lg-3 col-sm-6 align-items-center mb-lg-0 mb-3">
                    ...
                    <div>
                      <h2 class="title"><a href="javascript:void(0);" class="text-dark">Animator</a></h2>
                      <span class="text-primary fs-13">Highspeed Studios</span>
                    </div>
                  </div>
                  <div class="d-flex col-lg-3 col-sm-6 align-items-center mb-lg-0 mb-3">
                ...
                <div class="d-flex flex-wrap search-row p-3 mb-3 rounded justify-content-between align-items-center">
                  <div class="d-flex col-lg-3 col-sm-6 align-items-center mb-lg-0 mb-3">
                    ...
                    <div>
                      <h2 class="title"><a href="javascript:void(0);" class="text-dark">Designer</a></h2>
                      <span class="text-primary fs-13">Highspeed Studios</span>
                    </div>
                  </div>
                  <div class="d-flex col-lg-3 col-sm-6 align-items-center mb-lg-0 mb-3">
                ...
                <div class="d-flex flex-wrap search-row p-3 mb-3 rounded justify-content-between align-items-center">
                  <div class="d-flex col-lg-3 col-sm-6 align-items-center mb-lg-0 mb-3">
                    <div class="icon-img-bx me-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 71 71">
                        <g transform="translate(0.243)">
                          <rect width="71" height="71" rx="12" transform="translate(-0.243)" fill="#ee27c0"></rect>
                          <g transform="translate(-0.243)">
                ...
                <div class="d-flex flex-wrap search-row p-3 mb-3 rounded justify-content-between align-items-center">
                  <div class="d-flex col-lg-3 col-sm-6 align-items-center mb-lg-0 mb-3">
                    ...
                    <div>
                      <h2 class="title"><a href="javascript:void(0);" class="text-dark">Graphic Designer</a></h2>
                ...
                <div class="d-flex flex-wrap search-row p-3 mb-3 rounded justify-content-between align-items-center">
                  <div class="d-flex col-lg-3 col-sm-6 align-items-center mb-lg-0 mb-3">
                    ...
                    <div>
                      <h2 class="title"><a href="javascript:void(0);" class="text-dark">Data Scientist</a></h2>
          ...
          <div class="col-xl-12">
            <div class="card">
              <div class="card-header bg-blue">
                <div class="researcher"></div>
              </div>
              <div class="card-body">
                <span class="text-center d-block block">
                  <svg xmlns="http://www.w3.org/2000/svg" width="141" height="141" viewBox="0 0 141 141">
                    <g transform="translate(8.243 8)">
                      <g transform="translate(-0.243)" fill="#c5c5c5" stroke="var(--card)" stroke-width="8">
                      ...
                      <g transform="translate(-0.243)">
                        ...
                        <ellipse
                          ...
                          rx="18.914"
                          ry="19.366"
                          transform="translate(64.145 26.408)"
                          fill="#ffe70c"
                          style="mix-blend-mode: multiply; isolation: isolate"
                        />
                      </g>
                ...
                <div>
                  <span class="mb-2 d-flex"><i class="fas fa-star orange me-3 mt-1"></i>Tempor incididunt ut labore </span>
                  <span class="mb-2 d-flex"><i class="fas fa-star orange me-3 mt-1"></i>Lorem ipsum dolor </span>
                  <span class="mb-2 d-flex"><i class="fas fa-star orange me-3 mt-1"></i>Sit amet consectetur </span>
                  <span class="mb-2 d-flex"><i class="fas fa-star orange me-3 mt-1"></i>Labore adipsicans elit do uasde </span>
                </div>
                <div class="location">
              ...
              <div class="card-footer border-0 pt-0">
                <div class="d-flex justify-content-between align-items-center">
                  ...
                  <a href="javascript:void(0);" class="btn btn-secondary btn-sm btn-rounded light"><i class="far fa-bookmark fs-20"></i></a>
                </div>
              </div>
            </div>
          </div>
