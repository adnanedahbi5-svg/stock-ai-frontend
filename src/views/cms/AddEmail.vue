<template>
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-xl-12">
        <RouterLink to="/email-template" class="btn btn-sm btn-primary mb-4">List Email Template</RouterLink>
      </div>
      <div class="col-xl-12">
        <div class="filter cm-content-box box-primary">
          <div class="content-title SlideToolHeader">
            <div class="cpa"><i class="fa-solid fa-envelope me-2"></i>Add Email Template</div>
            <div class="tools">
