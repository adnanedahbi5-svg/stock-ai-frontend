            ...
            <div class="basic-form">
              <form>
                <div class="mb-3">
                  ...
                  <FormSelectOptin class="default-select form-control wide" :optionArray="selectNum" />
                </div>
                <v-select
                  placeholder="1"
                  class="wide mt-3"
              ...
              <form>
                <div class="mb-3">
                  <div class="form-check form-check-inline">
                    <label class="form-check-label"> <input type="checkbox" class="form-check-input" value="" checked />Option 1 </label>
                  </div>
                  <div class="form-check form-check-inline">
                    <label class="form-check-label"> <input type="checkbox" class="form-check-input" value="" />Option 2 </label>
                  </div>
                  <div class="form-check form-check-inline disabled">
                    <label class="form-check-label"> <input type="checkbox" class="form-check-input" value="" disabled />Disabled </label>
                  </div>
                </div>
              </form>
            </div>
                ...
                <div class="row align-items-center">
                  <div class="col-auto my-1">
                    ...
                    <v-select
                      ...
                      style="width: 130px"
                      placeholder="Choose..."
                      :options="[{ title: 'Choose...' }, { title: 'One' }, { title: 'Two' }, { title: 'Three' }]"
                      label="title"
                    />
                  </div>
                </div>
