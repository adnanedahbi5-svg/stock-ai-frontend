    ...
    <div class="row">
                ...
                <li>
                  <div class="timeline-panel">
                    ...
                    <div class="media-body">
                      ...
                      <a href="#" class="btn btn-primary btn-xxs shadow me-1">Reply</a>
      ...
      <div class="col-xl-4 col-lg-12 col-sm-12">
        <div class="card overflow-hidden">
          ...
          <div class="card-footer border-0 mt-0">
            <button class="btn btn-primary btn-lg btn-block"><i class="fa fa-bell-o"></i> Reminder Alarm</button>
          </div>
        </div>
      </div>
      ...
      <div class="col-xl-4 col-lg-6 col-xxl-4 col-sm-6">
        <div class="card text-white bg-primary">
          <ul class="list-group list-group-flush">
            <li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Experience :</span><strong>2+ years</strong></li>
            <li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Skills :</span><strong>Html, Css </strong></li>
            <li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Salary :</span><strong>$2000</strong></li>
            <li class="list-group-item d-flex justify-content-between text-white"><span class="mb-0">Position :</span><strong>Web Designer</strong></li>
