        ...
        <div class="row">
          ...
          <div class="col-xl-6 col-lg-12 col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <Bar
                  :data="barChart_2.data"
                  :options="barChart_2.options"
                  id="barChart_2"
                  ref="chartJs"
                />
              </div>
          ...
          <div class="col-xl-6 col-lg-12 col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <Bar
                  :data="barChart_3.data"
                  :options="barChart_3.options"
                  id="barChart_3"
                  ref="chartJs"
                />
              </div>
          ...
          <div class="col-xl-6 col-lg-12 col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <Line
                  :data="lineChart_1.data"
                  :options="lineChart_1.options"
                  id="lineChart_1"
                  ref="chartJs"
                />
              </div>
          ...
          <div class="col-xl-6 col-lg-12 col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <Line
                  :data="lineChart_3.data"
                  :options="lineChart_3.options"
                  id="lineChart_3"
                  ref="chartJs"
                />
              </div>
          ...
          <div class="col-xl-6 col-lg-12 col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <Line
                  :data="areaChart_1.data"
                  :options="areaChart_1.options"
                  id="areaChart_1"
                  ref="chartJs"
                />
              </div>
          ...
          <div class="col-xl-6 col-lg-12 col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <Line
                  :data="areaChart_2.data"
                  :options="areaChart_2.options"
                  id="areaChart_2"
                  ref="chartJs"
                />
              </div>
          ...
          <div class="col-xl-6 col-lg-12 col-sm-12">
            <div class="card">
              ...
              <div class="card-body">
                <Line
                  :data="areaChart_3.data"
                  :options="areaChart_3.options"
                  id="areaChart_3"
                  ref="chartJs"
                />
              </div>
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            <div class="card">
              ...
              <div class="card-body">
                <Radar
                  :data="radar_chart.data"
                  :options="radar_chart.options"
                  id="radar_chart"
                  ref="chartJs"
                />
              </div>
              ...
              <div class="card-body">
                <div class="chart-point">
                  <div class="check-point-area">
                    <Doughnut
                      :data="doughnut_chart.data"
                      :options="doughnut_chart.options"
                      id="doughnut_chart"
                    />
                  </div>
          ...
          <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            <div class="card">
              ...
              <div class="card-body">
                <PolarArea
                  :data="polar_chart.data"
                  :options="polar_chart.options"
                  id="polar_chart"
                />
              </div>
            </div>
...
import { Bar, Line, PolarArea, Pie, Doughnut, Radar } from 'vue-chartjs'
import {
  barChart_1,
  barChart_2,
  barChart_3,
...
export default defineComponent({
  name: 'chartJs',
  components: { Bar, Line, PolarArea, Pie, Doughnut, Radar },
  data() {
    return {
      barChart_1,
      barChart_2,
