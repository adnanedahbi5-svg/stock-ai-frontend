        ...
        <div class="card">
          <div class="card-body">
            <div class="post-details">
              ...
              <p>
                A Collection of textile samples lay spread out on the table - Samsa was a travelling salesman - and above it there hung a picture that he had recently cut
                out of an illustrated magazine and housed in a nice, gilded frame.
              </p>
              <blockquote>
                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Has been the industry's standard text ever since the 1500s, when an unknown
                printer took a galley of type and scrambled it to make a type specimencenturies.
              </blockquote>
              <p>
                ...
                the charm of existence was created for the bliss of souls like mine.I am so happy, my dear friend, so absorbed in the exquisite sense of mere tranquil
                existence, that I neglect my talents.
              </p>
              <div class="profile-skills mt-5 mb-5">
                <h4 class="text-primary mb-2">Skills</h4>
                <a href="javascript:void();;" class="btn btn-primary light btn-xs mb-1 me-1">Admin</a>
                <a href="javascript:void();;" class="btn btn-primary light btn-xs mb-1 me-1">Dashboard</a>
                <a href="javascript:void();;" class="btn btn-primary light btn-xs mb-1 me-1">Photoshop</a>
                <a href="javascript:void();;" class="btn btn-primary light btn-xs mb-1 me-1">Bootstrap</a>
                <a href="javascript:void();;" class="btn btn-primary light btn-xs mb-1 me-1">Responsive</a>
