    ...
    <div class="row">
      ...
      <div class="col-xl-6">
        <div class="card">
          <div class="card-header d-block">
            ...
            <p class="mb-0 subtitle">add <code>.alert-alt</code> class to change the solid color.</p>
          </div>
          <div class="card-body">
      ...
      <div class="col-xl-6">
        <div class="card">
          <div class="card-header d-block">
            ...
            <p class="mb-0 subtitle">add <code>.alert-alt.solid</code> class to change the solid color.</p>
          </div>
          <div class="card-body">
      ...
      <div class="col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <div class="alert alert-primary alert-dismissible fade show">
              <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"></button>
              <strong>WOW! Eveything looks OK.</strong> <a href="#">Please check this one as well</a>
            </div>
      ...
      <div class="col-xl-6">
        <div class="card">
          ...
          <div class="card-body">
            <div class="alert alert-primary solid alert-dismissible fade show">
              <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"></button> WOW! Eveything looks OK.
            ...
            <div class="alert alert-info solid alert-dismissible fade show">
              <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"></button> Hey! Take a quick look.
            ...
            <div class="row">
              ...
              <div class="col-xl-6">
                <div class="alert alert-danger notification">
                  <p class="notificaiton-title mb-2"><strong>Danger! </strong> Religion And Science</p>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <div class="alert alert-primary solid alert-end-icon alert-dismissible fade show">
              ...
              <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"></button> Success! Message has been sent.
            </div>
            ...
            <div class="alert alert-info solid alert-end-icon alert-dismissible fade show">
              ...
              <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="btn-close"></button> Info! You have got 5 new email.
            </div>
      ...
      <div class="col-xl-12 col-xxl-12">
        <div class="card">
          <div class="card-header d-block">
            ...
            <p class="mb-0 subtitle">add <code>.alert-social .facebook,.twitter,.linkedin,.google-plus</code> to change the style</p>
          </div>
          <div class="card-body">
            <div class="row">
              <div class="col-xl-6">
                <div class="alert alert-social facebook alert-dismissible fade show">
                  ...
                  <div class="media">
                    ...
                    <div class="media-body">
                      ...
                      <p class="mb-0">
                        Cras sit amet nibh libero, in gravida nulla. tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis
                        in faucibus.
                      </p>
                    </div>
                  </div>
