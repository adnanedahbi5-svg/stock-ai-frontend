<template>
  <div class="col-xl-3 col-lg-6 col-sm-5 chat-border mobile-chat chat-left-area">
    <div class="chat-p shaprate">
      <div class="d-flex">
        <img src="../../assets/images/contacts/d1.jpg" class="avatar avatar-md rounded-circle" alt="" />
        <div class="ms-2">
    ...
    <div class="people-list dz-scroll">
      <div class="chat-p style-1" v-for="({ img, name, time, userActive }, ind) in chatColumn" :key="ind">
...
export default defineComponent({
  ...
  setup() {
    return {
      chatColumn: [
        { img: IMAGE.contactPic1, name: "K kumar", time: "1 mIn" },
        { img: IMAGE.contactPic2, name: "Honey Risher", time: "2 mIn", userActive: "active" },
        { img: IMAGE.contactPic3, name: "Liam Antony", time: "5 mIn" },
        { img: IMAGE.contactPic555, name: "Ricky M", time: "4 mIn", userActive: "active" },
        { img: IMAGE.contactPic1, name: "Elijah James", time: "2 mIn" },
        { img: IMAGE.contactPic2, name: "Oliver Noah", time: "5 mIn", userActive: "active" },
        { img: IMAGE.contactPic3, name: "Ricky M", time: "4 mIn", userActive: "active" },
        { img: IMAGE.contactPic555, name: "Ricky Antony", time: "1 mIn", userActive: "active" },
        { img: IMAGE.contactPic1, name: "Ricky Antony", time: "2 mIn", userActive: "active" },
        { img: IMAGE.contactPic2, name: "Ankites Risher", time: "5 mIn", userActive: "active" },
        { img: IMAGE.contactPic3, name: "Ricky M", time: "4 mIn", userActive: "active" },
        { img: IMAGE.contactPic555, name: "William Risher", time: "2 mIn", userActive: "active" },
        { img: IMAGE.contactPic1, name: "Oliver Noah", time: "5 mIn", userActive: "active" },
        { img: IMAGE.contactPic2, name: "Ricky M", time: "4 mIn", userActive: "active" },
        { img: IMAGE.contactPic3, name: "Elijah James", time: "2 mIn", userActive: "active" },
      ],
    };
  },
});
