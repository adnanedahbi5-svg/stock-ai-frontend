...
const qtyPage = ref(10);

const { paginatedData, data, goToPage, nextPage, perPage, backPage, addActive, sortingArr, searchData, qtyshowPage } = handlePagination(tableDatabase, qtyPage.value);
