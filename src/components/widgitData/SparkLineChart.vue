    ...
    <div class="row">
        ...
        <div class="widget-stat card bg-primary">
          ...
          <div class="card-body text-center">
            <div class="ico-sparkline">
              <div id="sparkline12">
                <apexchart type="pie" height="130" id="user-activity" :options="state.chartOptions" :series="state.series"></apexchart>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
        <div class="widget-stat card bg-warning overflow-hidden">
          ...
          <div class="card-body text-center p-0">
            <div class="ico-sparkline">
              <div id="spark-bar-2" style="height: 140px">
                <apexchart type="bar" :options="state2.chartOptions" :series="state2.series"></apexchart>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
        <div class="widget-stat card bg-secondary">
          ...
          <div class="card-body p-0">
            <div class="px-4" style="height: 158px; overflow: hidden">
              <apexchart type="bar" :options="state3.chartOptions" :series="state3.series"></apexchart>
            </div>
          </div>
        </div>
      </div>
      <div class="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
        <div class="widget-stat card bg-danger overflow-hidden">
          ...
          <div class="card-body p-0" style="height: 158px">
            <apexchart type="area" :options="state4.chartOptions" :series="state4.series"></apexchart>
          </div>
        </div>
      </div>
    </div>
  ...
  setup() {
    ...
    const state2 = reactive({
      series: [
        {
          name: "bar chart",
          data: [33, 22, 68, 54, 8, 30, 74, 7, 33, 22, 68, 54, 8, 30, 74, 7],
          bars: {
            show: true,
            lineWidth: 0,
            fillColor: "#0d99ff",
