import { L as Teleport, N as Fragment, mt as h, rt as defineComponent } from "./runtime-dom.esm-bundler-CeqIid9a.js";
import { p as CustomRenderingStore, t as Calendar } from "./core-oUa8Q8FZ.js";
import "./internal-DtlLkYME.js";
import "./vue.js";
//#region node_modules/@fullcalendar/vue3/dist/options.js
...
//#endregion
//#region node_modules/@fullcalendar/vue3/dist/FullCalendar.js
var FullCalendar = defineComponent({
	...
	render() {
		...
		for (const customRendering of this.customRenderingMap.values()) customRenderingNodes.push(h(CustomRenderingComponent, {
			key: customRendering.id,
			customRendering
		}));
		return h("div", { attrs: { "data-fc-render-id": this.renderId } }, h(Fragment, customRenderingNodes));
	},
	mounted() {
...
function buildWatchers() {
	...
	for (let complexOptionName in OPTION_IS_COMPLEX) watchers[`options.${complexOptionName}`] = {
		deep: true,
		handler(val) {
			if (val !== void 0) {
				let calendar = this.getApi();
				calendar.pauseRendering();
				calendar.resetOptions({ [complexOptionName]: val }, [complexOptionName]);
				this.renderId++;
			}
		}
	};
...
function kebabToCamelKeys(map) {
	const newMap = {};
	for (const key in map) newMap[kebabToCamel(key)] = map[key];
	return newMap;
}
...
//#endregion
//#region node_modules/@fullcalendar/vue3/dist/index.js
var dist_default = FullCalendar;
//#endregion
