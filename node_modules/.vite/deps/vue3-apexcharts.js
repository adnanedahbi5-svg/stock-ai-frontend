import { Ht as openBlock, It as onMounted, J as createElementBlock, Mt as onBeforeUnmount, Tr as normalizeClass, _n as watch, dt as getCurrentInstance, er as toRefs, jt as onBeforeMount, kt as nextTick, mt as h, qn as ref, rt as defineComponent, zt as onServerPrefetch } from "./runtime-dom.esm-bundler-CeqIid9a.js";
import "./vue.js";
...
var C = [
	...
	setup(t) {
		...
		return onServerPrefetch(async () => {
			try {
				const { default: r } = await import("./apexcharts.ssr.esm-fe46cd2d-DJrprawI.js"), n = Object.assign({}, t.options, {
...
var M = /* @__PURE__ */ oe(ae, [["render", se]]), P = defineComponent({
	...
	setup(t) {
		...
		onMounted(async () => {
			try {
				const { default: r } = await import("./apexcharts.ssr.esm-fe46cd2d-DJrprawI.js");
