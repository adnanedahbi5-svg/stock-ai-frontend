import { Dr as normalizeStyle, E as withModifiers, G as createBaseVNode, Ht as openBlock, J as createElementBlock, Jt as renderList, K as createBlock, L as Teleport, N as Fragment, Sn as withCtx, T as withKeys, Tr as normalizeClass, Yt as renderSlot, et as createTextVNode, jr as toDisplayString, q as createCommentVNode, t as Transition, tt as createVNode, w as vShow, wn as withDirectives } from "./runtime-dom.esm-bundler-CeqIid9a.js";
import "./vue.js";
...
var multiselectMixin = {
	...
	computed: {
		...
		filteredOptions() {
			...
			/* istanbul ignore else */
			if (this.taggable && normalizedSearch.length && !this.isExistingOption(normalizedSearch)) if (this.tagPosition === "bottom") options.push({
				isTag: true,
				label: search
			});
	...
	methods: {
		...
		pointerForward() {
			...
			if (this.pointer < this.filteredOptions.length - 1) {
				...
				if (this.$refs.list?.scrollTop <= this.pointerPosition - (this.visibleElements - 1) * this.optionHeight) this.$refs.list.scrollTop = this.pointerPosition - (this.visibleElements - 1) * this.optionHeight;
				/* istanbul ignore else */
		...
		pointerBackward() {
			if (this.pointer > 0) {
				this.pointer--;
				/* istanbul ignore else */
				if (this.$refs.list?.scrollTop >= this.pointerPosition) this.$refs.list.scrollTop = this.pointerPosition;
				/* istanbul ignore else */
	...
	return openBlock(), createElementBlock("div", {
		...
		createBaseVNode("div", _hoisted_2, [
			renderSlot(_ctx.$slots, "selection", {
				...
				isOpen: _ctx.isOpen
			}, () => [withDirectives(createBaseVNode("div", _hoisted_3, [(openBlock(true), createElementBlock(Fragment, null, renderList($options.visibleValues, (option, index) => {
				...
				}, [createBaseVNode("span", { textContent: toDisplayString(_ctx.getOptionLabel(option)) }, null, 8, _hoisted_4), createBaseVNode("i", {
					tabindex: "1",
