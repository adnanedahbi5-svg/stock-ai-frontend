//#region node_modules/lightgallery/plugins/thumbnail/lg-thumbnail.es5.js
/*!
...
var Thumbnail = function() {
		...
		if (this.settings.animateThumb) {
			...
			switch (this.settings.currentPagerPosition) {
				...
				case "middle":
					...
					break;
				case "right": position = this.thumbOuterWidth - this.settings.thumbWidth;
			}
	...
	Thumbnail.prototype.getThumbHtml = function(thumb, index, alt) {
		...
		var thumbImg;
		if (slideVideoInfo.youtube) if (this.settings.loadYouTubeThumbnail) thumbImg = "//img.youtube.com/vi/" + slideVideoInfo.youtube[1] + "/" + this.settings.youTubeThumbSize + ".jpg";
		else thumbImg = thumb;
		else thumbImg = thumb;
